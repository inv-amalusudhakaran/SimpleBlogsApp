...
# # Blog Post Endpoints
# @app.get("/api/posts", response_model=List[schemas.BlogPost])
...
# @app.get("/api/posts/{post_id}", response_model=schemas.BlogPost)
...
# @app.post("/api/posts", response_model=schemas.BlogPost, status_code=status.HTTP_201_CREATED)
# def create_post(
...
# @app.put("/api/posts/{post_id}", response_model=schemas.BlogPost)
# def update_post(
#     post_id: int,
